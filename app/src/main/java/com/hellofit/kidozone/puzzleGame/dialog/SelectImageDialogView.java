...
/***
 *  This class is the dialog to select attraction image
 *
...
public class SelectImageDialogView extends DialogFragment {
    ...
    public class ImageListAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            Bitmap bitmap = Utils.readBitmap(activity.getApplicationContext(), ImageSoures.imageSoursView[position], 3);
            viewHolder.imageView.setImageBitmap(bitmap);
        }

        @Override
        public int getItemCount() {
            return ImageSoures.imageSoursView.length;
        }
    }
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (getAdapterPosition() != -1 && itemClickListener != null) {
                        itemClickListener.itemClick(getAdapterPosition(), ImageSoures.imageSoursView[getAdapterPosition()]);
                        dismiss();
                    }
                }
            });
