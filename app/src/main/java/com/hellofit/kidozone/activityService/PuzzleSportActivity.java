...
import com.hellofit.kidozone.puzzleGame.dialog.SelectImageDialogSport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                AlertDialog builder = new AlertDialog.Builder(PuzzleSportActivity.this)
                        .setTitle("Oops...")
                        ...
                        .setPositiveButton("Yes, I'm leaving!", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(PuzzleSportActivity.this, MainActivity.class);
